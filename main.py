...
questions = [
    ...
    "Which product with atleast 100 reviews category has the highest rate of 5-star reviews? [string: category_name]",
    "What's the most common payment installment count for orders over 1000 BRL? [integer: installments]",
    "Which city with atleast 50 orders has the highest average freight value per order? [string: city_name]",
